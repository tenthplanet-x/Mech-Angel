	...
	)
{
	...
	HTTPMD5Init(&Md5Ctx);
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszUserName, (unsigned)strlen(pszUserName)); //Daniel casting
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszRealm, nRealmLength); //Daniel
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszPassword, (unsigned)strlen(pszPassword)); //Daniel
	...
	if (nAlg == 1)  /* MD5-Sess */
	{
		...
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszCNonce, (unsigned)strlen(pszCNonce));
	...
	)
{
	...
	// Calculate H(A2)
	HTTPMD5Init(&Md5Ctx);
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszMethod, (unsigned)strlen(pszMethod));
	HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
	...
	if (*pszQop) 
	{
		...
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszNonceCount, (unsigned)strlen(pszNonceCount));
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)pszCNonce, (unsigned)strlen(pszCNonce));
		HTTPMD5Update(&Md5Ctx, (const unsigned char *)":", 1);
